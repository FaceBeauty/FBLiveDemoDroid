package com.nimo.common.media.video;
...
import com.nimo.common.media.video.encoder.MediaAudioEncoder;
import com.nimo.common.media.video.encoder.MediaAudioFileEncoder;
import com.nimo.common.media.video.encoder.MediaEncoder;
import com.nimo.common.media.video.encoder.MediaMuxerWrapper;
import com.nimo.common.media.video.encoder.MediaVideoEncoder;
import com.nimo.common.utils.DecimalUtils;
import com.nimo.common.utils.FileUtils;
...
public class VideoRecordHelper {
     ...
     * @param mvpMatrix
     */
    public void frameAvailableSoon(int texId, float[] texMatrix, float[] mvpMatrix, boolean isFrontCamera) {
        synchronized (mRecordLock) {
            if (mVideoEncoder != null) {
                ...
                mVideoEncoder.frameAvailableSoon(texId, texMatrix, matrix, isFrontCamera);
                if (!isStopRecording) {
