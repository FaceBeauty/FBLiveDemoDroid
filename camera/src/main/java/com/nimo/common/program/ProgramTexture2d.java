package com.nimo.common.program;
...
public class ProgramTexture2d extends Program {
    ...
    // Simple vertex shader, used for all programs. 左下角为坐标原点
    ...
    // Simple vertex shader, used for all programs. 中心点为坐标原点
    private static final String VERTEX_SHADER_CENTER_ORIGIN =
            "uniform mat4 uMVPMatrix;\n" +
                    "uniform mat4 uTexMatrix;\n" +
                    "attribute vec4 aPosition;\n" +
                    "attribute vec4 aTextureCoord;\n" +
    ...
    public ProgramTexture2d(boolean leftBottomOriginMode) {
        super(leftBottomOriginMode ? VERTEX_SHADER : VERTEX_SHADER_CENTER_ORIGIN, FRAGMENT_SHADER_2D);
    }
