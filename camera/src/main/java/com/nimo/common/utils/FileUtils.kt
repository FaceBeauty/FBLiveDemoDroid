...
import com.nimo.common.entity.TextureImage
...
object FileUtils {
    ...
    fun loadBundleFromLocal(context: Context, path: String): ByteArray? {
        ...
        Log.d(TAG, "loadBundleFromLocal failed path:$path")
        return null
    }
    ...
    fun loadStringFromLocal(context: Context, path: String): String? {
        ...
        Log.d(TAG, "loadStringFromLocal failed path:$path")
        return content
    }
    ...
    fun loadBitmapFromLocal(context: Context, path: String): Bitmap? {
        ...
        inputStream?.let {
            try {
                ...
                e.printStackTrace()
                Log.d(TAG, "loadBitmapFromLocal failed path:$path")
            } finally {
                try {
                    it.close()
                } catch(e: Exception) {
    ...
    fun loadRgbaColorFromLocal(context: Context, path: String): DoubleArray? {
        ...
        Log.d(TAG, "loadRgbaColorFromLocal  path:$path   colors:${colors?.contentToString()}")
        return colors
    }
    ...
    fun loadTextureImageFromLocal(context: Context, path: String): TextureImage? {
        ...
        Log.d(TAG, "loadTextureImageFromLocal failed path:$path")
        return null
    }
